...
class MPRenderer(IRenderer):
    ...
    def __init__(self, draw_params: Union[ParamServer, dict, None] = None,
                 ...
                 figsize: Union[None, Tuple[float, float]] = None, focus_obstacle: Union[None, Obstacle] = None, action_dict=None):
        """
...
def create_video(scenario: Scenario,
    ...
    frame_count = max([obstacle.prediction.final_time_step for obstacle in scenario.obstacles], default=0) + frame_count_padding
    ...
    dpi = 150
    figsize = (5, 5)
    rnd = MPRenderer(figsize=figsize, draw_params={"axis_visible": False}, action_dict=action_dict)
