...
class DynamicObstacleXMLNode:
    ...
    def create_node(cls, dynamic_obstacle: DynamicObstacle) -> et.Element:
        ...
        #write intial state
        initial_state_node_root = et.Element('trajectory')
        initial_state_node = et.Element('state')
        ...
        initial_state_node_root.append(initial_state_node)
        obstacle_node.append(initial_state_node_root)
...
class StateXMLNode:
    ...
    def create_goal_state_node(cls, state: State, goal_lanelet_ids: List[int]) -> et.Element:
        ...
        :return: node
        """
        state_node_root = et.Element('goalRegion')
        state_node = et.Element("state")
        ...
        state_node_root.append(state_node)

        return state_node_root
