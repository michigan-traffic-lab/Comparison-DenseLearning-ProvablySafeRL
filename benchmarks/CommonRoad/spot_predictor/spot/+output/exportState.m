...
%------------- BEGIN CODE --------------
    ...
    yawRateNode = doc.createElement('yawRate'); 
    yawRateNode_exact = doc.createElement('exact');
    yawRateNode_exact.appendChild(doc.createTextNode(num2str(0.0)));
    yawRateNode.appendChild(yawRateNode_exact);
    stateNode.appendChild(yawRateNode);
    slipAngleNode = doc.createElement('slipAngle'); 
    slipAngleNode_exact = doc.createElement('exact');
    slipAngleNode_exact.appendChild(doc.createTextNode(num2str(0.0)));
    slipAngleNode.appendChild(slipAngleNode_exact);
    stateNode.appendChild(slipAngleNode);
end
